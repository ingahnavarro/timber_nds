...
def calculate_dcr_for_wood_elements(
    ...
    axial_tension_load = forces.axial if forces.axial >= 0 else 0
    dcr_results["axial tension"] = -1 * axial_tension_load
    ...
    dcr_results["axial compression"] = -1 * axial_compression_load
